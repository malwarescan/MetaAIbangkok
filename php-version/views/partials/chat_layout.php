...
<!-- Content -->
<div data-hero class="relative min-h-[72dvh] md:min-h-screen w-full lg:ps-64 pt-8 md:pt-12 bg-white bg-[url('/assets/metaaisymbiote-beige.png')] bg-center bg-no-repeat bg-[length:48%_auto] sm:bg-[length:40%_auto] md:bg-[length:28%_auto] lg:bg-[length:18%_auto]" style="min-height: 72dvh;">
  <div class="py-8 md:py-12 lg:py-16 pt-[22%] sm:pt-[18%] md:pt-[12%] lg:pt-[8%]">
    ...
    <div class="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto text-center">
      <div class="flex justify-center items-center">
        <img src="/assets/metaaisymbiote.png" alt="meta(ai) symbiote logo" class="w-full h-auto max-w-[80vw] md:max-w-[220px] lg:max-w-[180px] xl:max-w-[160px] select-none" decoding="async" loading="eager" draggable="false">
      </div>
    </div>
    <!-- End Title (Logo only) -->

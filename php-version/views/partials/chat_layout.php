      ...
      <div class="absolute bottom-px inset-x-px p-2 rounded-b-lg bg-gray-100">
        <div class="flex flex-wrap justify-between items-center gap-2">
          ...
          <div class="flex items-center gap-x-1">
            <button type="button" class="inline-flex shrink-0 justify-center items-center size-8 rounded-lg text-gray-500 hover:bg-white focus:z-10 focus:outline-hidden focus:bg-white">

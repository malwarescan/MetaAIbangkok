...
<!-- Content -->
<div data-hero class="relative min-h-[72dvh] md:min-h-screen w-full lg:ps-64 pt-8 md:pt-12 bg-me-silver bg-[url('/assets/metaaisymbiote-beige.png')] bg-center bg-no-repeat bg-[length:48%_auto] sm:bg-[length:40%_auto] md:bg-[length:28%_auto] lg:bg-[length:18%_auto] grid grid-rows-[1fr_auto]" style="min-height: 72dvh;">
  <div class="row-start-1 flex items-center justify-center py-6 md:py-10 lg:py-12">
    <!-- Title (Logo only) -->
    <div class="max-w-4xl px-4 sm:px-6 lg:px-8 mx-auto text-center">
      <div class="flex justify-center items-center">
        <img src="/assets/metaaisymbiote.png" alt="meta(ai) symbiote logo" class="w-auto h-auto max-w-[70vw] md:max-w-[160px] lg:max-w-[120px] xl:max-w-[96px] select-none" decoding="async" loading="eager" draggable="false">
      </div>
    </div>
    <!-- End Title (Logo only) -->
  ...
  <!-- Composer -->
  <div class="row-start-2 w-full shrink-0 px-4 sm:px-6 lg:px-8 py-3 sm:py-6">

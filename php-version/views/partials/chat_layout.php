...
<!-- Content -->
<div data-hero class="relative min-h-[72dvh] md:min-h-screen w-full lg:ps-64 pt-6 md:pt-8" style="min-height: 72dvh;">
  <div class="py-6 md:py-10 lg:py-12 pt-[16%] md:pt-[8%]">
    <!-- Title -->

  ...
  <div class="h-full flex flex-col justify-center">
    <div class="mt-0 md:mt-2 max-w-4xl w-full text-center mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <h1 class="text-3xl font-bold text-gray-800 sm:text-4xl dark:text-white">
        <span id="hero-title-rotator" class="inline-block transition-all duration-500 ease-in-out opacity-100 translate-y-0" aria-live="polite">
          <?= htmlspecialchars($i18n['hero_h1']) ?>
        </span>
      </h1>
      <p class="mt-3 text-gray-600 dark:text-neutral-400">
        <span id="hero-subtitle-rotator" class="inline-block transition-all duration-500 ease-in-out opacity-100 translate-y-0" aria-live="polite">
    ...
    <div class="mt-6 md:mt-10 max-w-2xl w-full mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div id="chat-messages" class="mb-4 max-h-64 overflow-y-auto space-y-3 hidden">
        <!-- Messages will be dynamically inserted here -->
      </div>
      
      <!-- Input Area -->
      <div class="relative">
        <input id="chat-input" type="text" class="p-3 sm:p-4 block w-full border-gray-200 rounded-full sm:text-sm focus:border-me-core focus:ring-me-core disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Ask me anything...">
        <div class="absolute top-1/2 end-2 -translate-y-1/2">
          <button id="upload-btn" type="button" class="size-10 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-500 hover:text-gray-800 focus:outline-hidden focus:text-gray-800 disabled:opacity-50 disabled:pointer-events-none dark:text-neutral-400 dark:hover:text-white dark:focus:text-white">

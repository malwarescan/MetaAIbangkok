...
<body class="min-h-full bg-me-silver text-me-graphite antialiased [font-family:Inter,ui-sans-serif,system-ui]">
  ...
  <footer class="border-t border-black/5 bg-transparent dark:bg-transparent dark:border-neutral-700">
    <div class="max-w-7xl mx-auto px-4 py-8 text-sm text-center">
      <p class="text-gray-500 text-sm tracking-tight select-none">© <?= date('Y') ?> Meta Esthetic — Clinic Intelligence In Your Palm</p>
      <p class="mt-1 text-gray-500 text-sm tracking-tight select-none">AI Language Model Powered by <a href="https://www.nrlc.ai" class="text-blue-600 hover:underline dark:text-blue-400">nrlc.ai</a></p>
    </div>
  </footer>
